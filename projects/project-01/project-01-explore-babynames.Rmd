...
Visualize the distribution of births by __last__ letter for the year 2020, faceted by sex.

```{r question-3-visualize-3}
tbl_names_by_letter |> 
  # Filter for the year 2020
  filter(year == 2020) |>
  # Initialize a ggplot of pct_births vs. first_letter
...
Write a function that plot trends in the percentage of births for all names Ending with a specific last letter.

```{r question-3-visualize-4}
