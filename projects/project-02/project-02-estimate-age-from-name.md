...
plot_estimated_age <- function(tbl, my_name, my_sex) {
  tbl |> 
    ...
    geom_col(aes(y=nb_alive, color=p_alive), alpha=0.3)+
    # Add a line layer with y = nb_births, and appropriate colors
    geom_line(aes(y=nb_births, color=age))+
...
#> # A tibble: 25 × 9
#>    sex   name     x0_percent x25_percent x50_percent x75_percent x100_percent
#>    <chr> <chr>         <dbl>       <dbl>       <dbl>       <dbl>        <dbl>
#>  1 F     Betty             1          63          71          77         104.
#>  2 F     Carol             1          60          67          74         104.
#>  3 F     Barbara           1          60          68          74         104.
#>  4 F     Linda             1          61          68          73         104.
#>  5 F     Dorothy           1          59          69          76         106.
#>  6 F     Patricia          1          56          65          72         105.
#>  7 F     Donna             1          57          63          69         103.
#>  8 F     Nancy             1          57          65          71         104.
#>  9 F     Susan             1          56          63          69         105.
#> 10 F     Sandra            1          55          63          71         101.
#> # ℹ 15 more rows
...
tbl_names_extended_age |> 
  ...
  # Add labels (title, subtitle, x, y)
  labs(
    title = "The range for 25% to 75% of Age for Names (Females)",
    subtitle = "Sorted by Median Age",
    x = "Age",
    y = "Name"
  ) +
